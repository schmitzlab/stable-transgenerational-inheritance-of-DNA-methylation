...
# Usage: python unmethylate_allc_pe.py [-f] [-q] [-h] [-p=num_proc] [-v=coverage] <allc_file> [allc_file]*
...
def processInputs( allCFileAr, numProc, newCov, sampleFile, isPrint ):
	...
	results = [ pool.apply_async( processFile, args=(allcFile, newCov, isPrint) ) for allcFile in allCFileAr ]
...
def processFile( allcFileStr, newCov, isPrint ):
...
def parseInputs( argv ):
	...
	processInputs( allcFilesAr, numProc, newCov, sampleFile, isPrint )
